                                        ...
                                        <form class="form" action="{{route('admin.products.general.store')}}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="slug"> اسم بالرابط</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="categories" name="categories[]" class="select2 form-control"
                                                                    multiple>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="tags"> اختر ألعلامات الدلالية</label>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1" name="is_active"
                                                                   ...
                                                                   checked />
                                                            <label for="is_active" class="card-title ml-1">الحالة</label>
