                            ...
                            <div id="verticalmenu" class="verticalmenu" role="navigation">
                                <ul class="menu level1">
                                    <li class="item  parent"><a href="#" title="Laptops &amp; Accessories"><i
                                                ...
                                                style="background:url('themes/vinova_savemart/assets/img/modules/novverticalmenu/icon/laptop.png') no-repeat scroll center center;"></i>Laptops
                                            &amp; Accessories</a><span class="show-sub fa-active-sub"></span><span
                                            class="menu-sub-title">Dell. HP, Macbook, Alienware and etc...</span>
                                        <div class="dropdown-menu" style="width:222px">
                                            <ul>
                                                ...
                                                <li class="item "><a href="#" title="Dell Precision">Dell Precision</a>
                                                </li>
                                                <li class="item "><a href="#" title="Dell Alienware">Dell Alienware</a>
                                                </li>
                                                <li class="item "><a href="#" title="HP Pavilion">HP Pavilion</a></li>
                                                <li class="item "><a href="#" title="HDD Box - Caddy Bay">HDD Box -
                                                        Caddy Bay</a></li>
                                                <li class="item "><a href="#" title="Dell Latitude">Dell Latitude</a>
                                                </li>
                                                <li class="item "><a href="#" title="Dell Inspiron">Dell Inspiron</a>
                                                </li>
                                    ...
                                    <li class="item  parent group"><a href="#" title="Electronics"><i
                                                class="hasicon nov-icon"
                                                style="background:url('themes/vinova_savemart/assets/img/modules/novverticalmenu/icon/Electronic.png') no-repeat scroll center center;"></i>Electronics</a><span
                                    ...
                                    <li class="item  parent group"><a href="#" title="Audio &amp; Sound Devices"><i
                                                class="hasicon nov-icon"
                                                style="background:url('themes/vinova_savemart/assets/img/modules/novverticalmenu/icon/audio-sound.png') no-repeat scroll center center;"></i>Audio
                                            &amp; Sound Devices</a><span class="show-sub fa-active-sub"></span><span
                                    ...
                                    <li class="item  parent group"><a href="#" title="Smartphone &amp; Tablets"><i
                                                class="hasicon nov-icon"
                                                style="background:url('themes/vinova_savemart/assets/img/modules/novverticalmenu/icon/tablet.png') no-repeat scroll center center;"></i>Smartphone
                                    ...
                                    <li class="item "><a href="#" title="Gaming Gear"><i class="hasicon nov-icon"
                                                                                         style="background:url('themes/vinova_savemart/assets/img/modules/novverticalmenu/icon/game.png') no-repeat scroll center center;"></i>Gaming
                                            Gear</a><span class="menu-sub-title">Mouse, Headphone, Console ...</span>
                                    </li>
                                    <li class="item "><a href="#" title="Smart Watches "><i class="hasicon nov-icon"
                                                                                            style="background:url('themes/vinova_savemart/assets/img/modules/novverticalmenu/icon/smart-watch.png') no-repeat scroll center center;"></i>Smart
                                            Watches </a><span
                                            class="menu-sub-title">Lorem ipsum dolor sit amet quam</span></li>
                                    <li class="item "><a href="#" title="Camera"><i class="hasicon nov-icon"
                                                                                    style="background:url('themes/vinova_savemart/assets/img/modules/novverticalmenu/icon/camera.png') no-repeat scroll center center;"></i>Camera</a><span
                                            class="menu-sub-title">Lorem ipsum dolor sit amet quam</span></li>
                                    <li class="item "><a href="#" title="Monitor &amp; Television"><i
                                                class="hasicon nov-icon"
                                                style="background:url('themes/vinova_savemart/assets/img/modules/novverticalmenu/icon/monitor.png') no-repeat scroll center center;"></i>Monitor
